...
namespace ARDrone
{
  ...
  private:
	  /**
	   @brief Navdata demo buffer size
	   **/
	  static const int NAVDATA_DEMO_BUFFER_SIZE = 10240;
	  
	  /** 
	   @brief Threshold that forces the drone to disregard the first few pieces of navdata
	   **/
	  static const int NAVDATA_INIT_THRESHOLD = 5;

	  /**
	   @brief A CommunicationChannel specifically for receiving Navigation Data
	   @param The local port of the socket
	   **/
